# ApniRasoi - Food Delivery Platform 🚀

![ApniRasoi](./logos/Screenshot.png)

## Overview

ApniRasoi is a dynamic food delivery website created with the Swiggy API. It provides users with a seamless and interactive experience for discovering and ordering food from various restaurants.

## Live Project

Explore ApniRasoi live: 

## Key Features

- **Location-wise Rendering:** Discover restaurants based on your location. ApniRasoi intelligently adapts to your location or defaults to a specific city.
